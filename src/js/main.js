...
floatButton.onclick = () => {
  if (floatTextField.value  > 0.15 || floatTextField.value  < 0 || isNaN(floatTextField.value)) {
    alert('Input Value = must be between 0 and 0.15. Did not update floating point number.');
  } else {
    alert('Success');
